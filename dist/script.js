...
function (_Slider) {
  ...
  function MiniSlider(container, next, prev, activeClass, animated, autoPlay) {
    _classCallCheck(this, MiniSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MiniSlider).call(this, container, next, prev, activeClass, animated, autoPlay));
  }
